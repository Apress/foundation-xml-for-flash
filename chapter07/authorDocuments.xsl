	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>qryAuthorDocuments</title>
				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							<td>
								<div align="center">
									<strong>AuthorFirstName</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>AuthorLastName</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>AuthorOrganisation</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>documentPublishYear</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="qryAuthorDocuments">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="AuthorLastName"/>
								</td>
								<td>
